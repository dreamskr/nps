...
#### 1.安装
> 通过[actions](https://github.com/dreamskr/nps/actions)下载
...
## 五、更新日志(基于[yisier/nps](https://github.com/yisier/nps)的v0.26.19版本修改)
- 2024-07-01 v0.26.19
  - 1.调用新增修改客户端、隧道、域名的API，返回新增或修改后的记录json。这对于第三方开发对接很有用。
  - 2.修改默认日志级别为0，关闭默认http及https默认端口，修改默认管理端口为9000，默认打开允许本地代理。也可以修改nps.conf文件。
  - 3.增加展开客户端时，显示安装或注册系统服务的命令。
  - 4.增加上传到奶牛快传及坚果云，每周编译一次 ---待添加。
  - 5.修改以服务方式安装nps和npc的服务名及显示名称（因特殊场景需要，改了服务名及名称，可Fork回去自行修改，cmd/nps/nps.go的78~80行，cmd/npc/npc.go的69~71行）。
  - 6.管理域名和隧道时，客户端ID改成下拉列表选择。
  
  ![image](https://github.com/dreamskr/nps/assets/43511466/7aee6894-d5a9-4f63-b2b2-8415fb277a4a)
  ![image](https://github.com/dreamskr/nps/assets/43511466/d5f73b95-0d61-4aa3-9bdc-33e81d89b391)
  ![image](https://github.com/dreamskr/nps/assets/43511466/bee82f61-cb62-4e9f-85b3-bd2d750aa97d)
  ![image](https://github.com/dreamskr/nps/assets/43511466/ac282ade-174f-4975-b871-a6de57f57f42)
